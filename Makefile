run_app:
	...
	find pages_files -exec sed -i.bak 's|_dash-component-suites|test_dash\\/_dash-component-suites|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-layout|test_dash/_dash-layout.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-dependencies|test_dash/_dash-dependencies.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_reload-hash|test_dash/_reload-hash|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-update-component|test_dash/_dash-update-component|g' {} \;
	find pages_files -exec sed -i.bak 's|assets|test_dash/assets|g' {} \;
